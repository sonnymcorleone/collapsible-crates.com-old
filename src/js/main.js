...
function Pagination() {
  ...
  let currentPage = 1;
  let productsPerPage;
  let productsPerPageEle = document.getElementById("productsPerPage");
  if(productsPerPageEle){
    productsPerPage = Number(productsPerPageEle.getAttribute("value"));
  }
